...
project = 'Aliyun Ansible Documentation'
copyright = "2017 Alibaba, Inc"
...
html_short_title = 'Aliyun Ansible Documentation'
...
html_title = 'Aliyun Ansible Documentation'
...
# [howto/manual]).
latex_documents = [
  ('index', 'ansible.tex', 'Aliyun Ansible 1.0 Documentation',
   AUTHOR, 'manual'),
]
